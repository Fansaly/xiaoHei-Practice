...
这张网卡几乎和原生的一样，它与原始 Mac（BCM4360）中的芯片相同，已经过 OOB<sup id="ref-6">[[6]](#note-6)</sup> 的验证，FakePCIID 可以使用与之相应的 AirPort 标识。在 macOS Sierra (10.12) 中，它不像 BCM4352 网卡那样需要 5GHz 或者 fcvo 补丁。
